...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        protected sealed override void OnSizeChanged(EventArgs e)
        {
            ...
            if (!_ControlMode)
            {
                HeaderRect = new Rectangle(0, 0, Width - 14, MoveHeight - 5);
            }
            Invalidate();
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //G.FillRectangle(new SolidBrush(Color.FromArgb(25, 181, 25)), new Rectangle(0, 0, Width, 60));------ color original
            G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), new Rectangle(0, 0, Width, 60));
            //39, 51, 63
            ...
            if (_RoundCorners == true)
            {
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), 1, 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), 1, 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), 2, 1, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), 3, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 2, 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 2, 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 3, 1, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 4, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 2, Height - 3, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 2, Height - 4, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 4, Height - 2, 1, 1);
                G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), Width - 3, Height - 2, 1, 1);
            }
    ...
    class MonoFlat_ControlBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            //G.Clear(Color.FromArgb(25, 181, 25));----color original
            //39, 51, 63
            G.Clear(Color.FromArgb(43, 84, 144));
            ...
            if (_EnableHoverHighlight == true)
            {
                switch (ButtonHState)
                {
                    ...
                    case ButtonHoverState.Minimize:
                        if (_EnableMinimize == true)
                        {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), new Rectangle(3, 0, 30, Height));
                        }
                        break;
                    case ButtonHoverState.Maximize:
                        if (_EnableMaximize == true)
                        {
                            G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), new Rectangle(35, 0, 30, Height));
                        }
                        break;
                    case ButtonHoverState.Close:
                        G.FillRectangle(new SolidBrush(Color.FromArgb(43, 84, 144)), new Rectangle(66, 0, 35, Height));
                        break;
                }
            }
    ...
    public class MonoFlat_ButtonBlue : Control
    {
        ...
        public MonoFlat_ButtonBlue()
        {
            ...
            P1 = new Pen(Color.FromArgb(0, 90, 170)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(0, 50, 170)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(0, 90, 170), Color.FromArgb(0, 90, 190), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(0, 50, 170), Color.FromArgb(0, 90, 190), 90.0F);
            }
    ...
    public class MonoFlat_ButtonHoja : Control
    {
        ...
        public MonoFlat_ButtonHoja()
        {
            ...
            Size = new Size(146, 41);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(25, 191, 75)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(5, 120, 5)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(25, 191, 75), Color.FromArgb(25, 181, 25), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(5, 120, 5), Color.FromArgb(5, 111, 15), 90.0F);
            }

            Rectangle Rect = new Rectangle(0, 0, this.Width, this.Height);

            Shape.AddArc(Rect.X, Rect.Y, 50, 50, 180, 90);
            Shape.AddArc(Rect.X + Rect.Width - 1, Rect.Y, 90, 90, 270, 90);
            Shape.AddArc(Rect.X + Rect.Width - 50, Rect.Y + Rect.Height - 50, 50, 50, 0, 90);
            Shape.AddArc(Rect.X, Rect.Y + Rect.Height - 1, 90, 90, 90, 90);





            //Shape.AddArc(Rect.X + Rect.Width - 50, Rect.Y, 50, 50, 270, 90);
            //Shape.AddArc(Rect.X + Rect.Width - 50, Rect.Y + Rect.Height - 50, 50, 50, 0, 90);
            //Shape.AddArc(Rect.X, Rect.Y + Rect.Height - 50, 50, 50, 90, 90);



            //Shape.AddArc(0, 0, 50, 50, 180, 90);
            //Shape.AddArc(Width - 11, 0, 10, 10, -90, 90);
            //Shape.AddArc(0, Height - 11, 10, 10, 0, 90);
            //Shape.AddArc(0, 0, 50,50, 90, 90);
            Shape.CloseAllFigures();
            Invalidate();
        }
    ...
    #region  ButtonHojaRoja

    public class MonoFlat_ButtonHojaRoja : Control
    {
        ...
        public MonoFlat_ButtonHojaRoja()
        {
            SetStyle((System.Windows.Forms.ControlStyles)(ControlStyles.AllPaintingInWmPaint | ControlStyles.OptimizedDoubleBuffer | ControlStyles.ResizeRedraw | ControlStyles.SupportsTransparentBackColor | ControlStyles.UserPaint), true);
            ...
            Size = new Size(146, 41);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(220, 20, 40)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(220, 20, 50)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(220, 20, 40), Color.FromArgb(220, 20, 70), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(220, 20, 90), Color.FromArgb(220, 20, 100), 90.0F);
            }
    ...
    public class MonoFlat_Button : Control
    {
        ...
        public MonoFlat_Button()
        {
            ...
            Size = new Size(146, 41);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(25, 181, 25)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(5, 111, 15)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(25, 181, 25), Color.FromArgb(25, 181, 25), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(5, 111, 15), Color.FromArgb(5, 111, 15), 90.0F);
            }
